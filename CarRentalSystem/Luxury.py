...
class Luxury(Vehicle):
    def __init__(self,registrationNumber:str,model:str,year:int,type:VehicleType,status:VehicleStatus,baseRentalPrice:float):
        ...
        self.premiumfees=50.0
    
    #now writing the implementation of the abstract method 
    def calculateRentalPrice(self, days):
        return self.get_base_rental_price()*days*self.ratemultiplier+self.premiumfees
    

#this is the implementation for luxury vehicle inheriting from the vehicle class
